<?php
$title = "Claybrook Zoo - Add Fishes"; 
...
if(isset($_POST['submitBtn']))
	...
	if($_POST['name'] == "" || $_POST['date_joined'] == "" ||$_POST['life_span']=="") echo "<script>alert('Fill in all the fields')</script>";
		else
		{
			...
			$directoryTargeted = "../../images/fishes/"; //path of the file of the images
...
$content = loadTemplate('../../views/admin/v_addFishes.php',$cri);
?>