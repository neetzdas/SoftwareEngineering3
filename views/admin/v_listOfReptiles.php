  ...
  <div class="container-fluid">
  	<div class="row">
          <div class="col-lg-12">
            ...
            <h4 class="card-title" >List of Reptiles</h4>
             <div class="card-tools">
            <a href="addReptiles" class="btn btn-success">Add New</a>
          </div>
      </div>
          <div class="card-body table-responsive p-0">
              ...
              // using for each loop for diplaying details f the category
                foreach ($reptiles_list as $rowOf_reptile) {
                  ...
                  //actions taken
                  echo '<td><a href="editReptiles&edit_Id=' . $rowOf_reptile['id'].'" data-toggle="tooltip" title="Edit" class="btn btn-info btn-sm"><i class="far fa-edit"></i></a></td>';?> 
      
                    <td><a href="#" onclick="javascript: if(confirm('Are you sure?')){
                        document.location='editReptiles&del_Id=<?php echo $rowOf_reptile['id']?>';}" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Delete"><i class="far fa-trash-alt"></i></a>
                    </td>
                    <?php 
                    echo'</tr>';
                  }
